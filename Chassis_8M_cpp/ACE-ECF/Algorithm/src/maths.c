...
{
    acceleration_control->acc_limit = 0;
    acceleration_control->acc_now = 0;
    acceleration_control->Input = 0;
    acceleration_control->Last_Input = 0;
    acceleration_control->Output = 0;
}
